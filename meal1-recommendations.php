...
$meal1_query="SELECT * FROM updated_dataset WHERE ID='$meal1_id'";
    ...
    if($meal1_result=mysqli_query($con,$meal1_query))
    {
        ...
        {
            while($meal1_row=mysqli_fetch_assoc($meal1_result))
            {
                $cluster = $meal1_row['Cluster'];
                $category = $meal1_row['Category'];
                $energy_kcal = $meal1_row['Energy_kcal'];
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="header">
                <p class="header-title">Breakfast Meal Replacement</p>
            </div>
<?php
    ...
    while ($row = mysqli_fetch_assoc($recommend_result)) 
    {
        ...
        echo '
            ...
            <a href="replace-meal1.php?recipe='.$row['ID'].'"><i class="fa fa-solid fa-circle-check"></i></a>
