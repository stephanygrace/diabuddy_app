...
$meal3_query="SELECT * FROM updated_dataset WHERE ID='$meal3_id'";
    ...
    if($meal3_result=mysqli_query($con,$meal3_query))
    {
        ...
        {
            while($meal3_row=mysqli_fetch_assoc($meal3_result))
            {
                $cluster = $meal3_row['Cluster'];
                $category = $meal3_row['Category'];
                $energy_kcal = $meal3_row['Energy_kcal'];
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="header">
                <p class="header-title">Dinner Meal Replacement</p>
            </div>
<?php
    ...
    while ($row = mysqli_fetch_assoc($recommend_result)) 
    {
        ...
        echo '
            ...
            <a href="replace-meal3.php?recipe='.$row['ID'].'"><i class="fa fa-solid fa-circle-check"></i></a>
