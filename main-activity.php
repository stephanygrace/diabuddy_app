    ...
    <div class="container">
        ...
        <div class="card">
            <div class="user">
                ...
                <p class="user-name">Hi, <?php echo $_SESSION['user_name']; ?>!</p>
                
            </div>
            <form method = "POST" action = "customization.php">
            
                <div class="calorie-plan">
                    <h3>Calorie Plan</h3>
...
<?php while ($row=mysqli_fetch_assoc($meal1_result)) { ?>
                <a href="consumed_process.php?meal=meal1"><i class="fa fa-solid fa-circle-check"></i></a>
                ...
                <div class="nutri-facts">
                    <div class="row">
                        <div class="column">
                            <div class="card">
                                <div class="circle"><h3><?php echo round($row['Energy_kcal'],0);?></h3></div>
                        ...
                        <div class="column">
                            <div class="card">
                                <div class="circle"><h3><?php echo round($row['Carbohydrate_incl_fibre_g'],0);?></h3></div>
                        ...
                        <div class="column">
                            <div class="card">
                                <div class="circle"><h3><?php echo round($row['Protein_g'],0);?></h3></div>
                        ...
                        <div class="column">
                            <div class="card">
                                <div class="circle"><h3><?php echo round($row['Sugar_g'],0);?></h3></div>
                        ...
                        <div class="column">
                            <div class="card">
                                <div class="circle"><h3><?php echo round($row['Fat_g'],0);?></h3></div>
                        ...
                        <div class="column">
                            <div class="card">
                                <div class="circle"><h3><?php echo round($row['Fibre_g'],0);}?></h3></div>
...
<?php while ($row2=mysqli_fetch_assoc($meal2_result)) { ?> 
                <a href="consumed_process.php?meal=meal2"><i class="fa fa-solid fa-circle-check"></i></a>
...
<?php while ($row3=mysqli_fetch_assoc($meal3_result)) { ?>
                <a href="consumed_process.php?meal=meal3"><i class="fa fa-solid fa-circle-check"></i></a>
        ...
        <button class="btn btn-primary btn-custom" type="submit" value="Login" name="customize" style="margin-bottom: 80px;">Customize</button>
